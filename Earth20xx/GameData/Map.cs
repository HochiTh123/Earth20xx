...
namespace Earth20xx.GameData
{
        ...
        public void Generate(int xtile, int ytile)
        {
            ...
            for(int x = 0; x <= Tiles.GetUpperBound(0); x++)
            {
                for (int y = 0; y <= Tiles.GetUpperBound(1);y++)
                {
                    ...
                    if (Random.Next(100) <= 2)
                    {
                        Tiles[x, y].DownWall = WallPrototypes[2];
                    }
                    if (Random.Next(100) <= 2)
                    {
                        Tiles[x, y].RightWall = WallPrototypes[3];
                    }
                }
            }
    ...
    public class Tile
    {
        ...
        public WallPrototype RightWall;
        public WallPrototype DownWall;
        ...
        public void Draw(SpriteBatch spritebatch, GameTime gameTime)
        {
            ...
            RightWall?.Draw(spritebatch, Position, gameTime,layer);
            DownWall?.Draw(spritebatch, Position, gameTime,layer);
    ...
    public class WallPrototype
    {
        ...
        {
            spritebatch.Draw(Texture, position, null, Color.White, 0f, DrawPoint, 1f, SpriteEffects.None, layer -= 0.2f);
        }
